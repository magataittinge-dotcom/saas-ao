...
#   - business outcomes: "soumis", "gagné", "perdu", "sans_suite" (analysé
#     puis écarté en connaissance — un état de SUCCÈS produit, pas un échec)
...
class Project(Base):
    ...
    status = Column(
        SAEnum(
            "brouillon", "en_cours", "analyzed", "sans_suite",
            "soumis", "gagné", "perdu",
            name="project_status",
        ),
        nullable=False,
