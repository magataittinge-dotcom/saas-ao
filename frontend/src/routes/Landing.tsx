...
const STATS = [
  ...
  { value: '10 min', label: 'par mémoire technique', color: '#FFFFFF' },
...
export default function Landing() {
  ...
  return (
    <div
      ...
      style={{ background: '#0A0C11', color: '#F1F5F9', fontFamily: '"Geist Sans", system-ui, sans-serif' }}
    >
      ...
      <section className="relative min-h-screen flex flex-col overflow-hidden">
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
            ...
            <Link to="/" className="flex items-center gap-2.5 shrink-0">
              ...
              <span
                ...
                style={{ fontFamily: '"Geist Sans", system-ui, sans-serif', color: '#F4F6FA' }}
              >
                Synorix
              </span>
            </Link>
            ...
            <div className="hidden md:flex items-center gap-8">
              {[
                ...
                <button
                  ...
                  className="text-sm text-[#788295] hover:text-white transition-colors bg-transparent border-none cursor-pointer"
                >
                  {l.label}
                </button>
              ))}
            ...
            <div className="hidden md:flex items-center gap-3">
              <Link
                ...
                className="text-sm text-[#788295] hover:text-white transition-colors px-4 py-2"
              >
                Connexion
              </Link>
              <Link
            ...
            <button
              ...
              className="md:hidden p-2 text-[#788295]"
            >
          ...
          {mobileMenu && (
            <div className="md:hidden border-t border-white/[0.06] px-4 py-4 space-y-3" style={{ background: 'rgba(0,0,0,0.90)' }}>
              {['features', 'how', 'pricing'].map(id => (
                <button key={id} onClick={() => scrollTo(id)} className="block text-sm text-[#788295] hover:text-white transition-colors bg-transparent border-none cursor-pointer">
                  {id === 'features' ? 'Fonctionnalités' : id === 'how' ? 'Comment ça marche' : 'Tarifs'}
                </button>
              ))}
              <div className="flex gap-3 pt-2">
                <Link to={isSignedIn ? '/dashboard' : '/login'} className="text-sm text-[#788295]">Connexion</Link>
                <Link to="/register" className="text-sm font-semibold text-white px-4 py-2 rounded-lg" style={{ background: '#E4E9F2' }}>Essai gratuit</Link>
              </div>
            </div>
          )}
        </nav>
        ...
        <div className="relative z-10 flex-1 flex flex-col items-center justify-center px-4 pt-24 pb-16 text-center">
            ...
            {FLOATING_PILLS.map((pill, i) => (
              ...
              >
                <span
                  ...
                  style={{ background: '#E4E9F2', animation: 'pulse-dot 2s ease-in-out infinite' }}
                />
                {pill.label}
              </div>
            ))}
          ...
          >
            <span>✨</span>
            <span className="text-[#5C6678]">Propulsé par l'IA la plus avancée</span>
          </div>
          ...
          {/* Subtitle */}
          <p
            className="text-base sm:text-lg text-[#788295] max-w-2xl mx-auto mb-10 leading-relaxed"
          ...
          >
            <div className="flex -space-x-2">
              {[0, 1, 2, 3, 4].map(i => (
                <div
                  key={i}
                  className="w-7 h-7 rounded-full border-2 border-[#0A0C11] flex items-center justify-center text-[9px] font-bold text-white"
                  style={{ background: `linear-gradient(135deg, ${i % 2 === 0 ? '#E4E9F2' : '#FFFFFF'}, ${i % 2 === 0 ? '#FFFFFF' : '#E4E9F2'})` }}
                >
                  {['KB', 'SM', 'JL', 'AR', 'MC'][i]}
                </div>
              ))}
            </div>
            <span>Utilisé par <strong className="text-[#788295]">+50 entreprises BTP</strong></span>
          </div>
        </div>
        ...
        >
          ...
          >
            ...
            <div className="flex items-center gap-2 px-4 py-3 border-b border-white/[0.06]">
              ...
              <div className="w-3 h-3 rounded-full" style={{ background: '#E4E9F2' }} />
              <div className="flex-1 mx-4 h-6 rounded-md" style={{ background: 'rgba(255,255,255,0.04)', maxWidth: 300 }}>
                <div className="px-3 py-1 text-[10px] text-[#9BA4B5]">app.synorix.fr/dashboard</div>
              </div>
            </div>
            ...
            <div className="p-5 sm:p-6 space-y-4">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                {[
                  ...
                  { label: 'AO gagnés', val: '12', color: '#FFFFFF' },
                ...
                {['Construction 42 logements', 'Réhab. école Jean Jaurès', 'Voirie ZAC des Halles'].map((name, i) => (
                  ...
                  >
                    <div className="flex items-center justify-between">
                      <span className="text-xs font-medium text-[#1C222D] truncate">{name}</span>
                      <span className="text-[9px] px-1.5 py-0.5 rounded-full" style={{ background: 'rgba(228,233,242,0.12)', color: '#FFFFFF' }}>En cours</span>
                    </div>
                    <div className="h-1.5 rounded-full overflow-hidden" style={{ background: 'rgba(186,205,234,.13)' }}>
                      <div className="h-full rounded-full" style={{ width: `${[65, 40, 85][i]}%`, background: 'linear-gradient(90deg, #E4E9F2, #FFFFFF)' }} />
                    </div>
                    <div className="text-[10px] text-[#9BA4B5]">Étape {[3, 2, 5][i]}/6 · J-{[14, 7, 3][i]}</div>
                  </div>
                ))}
              </div>
            </div>
        ...
        <div className="relative overflow-hidden" style={{ maskImage: 'linear-gradient(90deg, transparent, black 15%, black 85%, transparent)' }}>
          <div className="flex whitespace-nowrap" style={{ animation: 'marquee-scroll 25s linear infinite' }}>
            {[...CLIENTS, ...CLIENTS].map((name, i) => (
              <span
                key={i}
                className="inline-block text-lg font-semibold text-[#E8EBF2] mx-10 sm:mx-16"
      ...
      <section id="features" className="py-20 sm:py-28 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            >
              Une IA experte en{' '}
              <span style={{ background: 'linear-gradient(90deg, #E4E9F2, #FFFFFF)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }}>
                marchés publics BTP
              </span>
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div
              ...
              style={{ background: '#0F1218', border: '1px solid rgba(186,205,234,.13)' }}
            >
              <div className="flex items-start gap-4 mb-5">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-[#1C222D] mb-1" style={{ fontFamily: '"Geist Sans", system-ui, sans-serif' }}>Analyse DCE intelligente</h3>
              ...
              <div className="rounded-lg p-4 space-y-2" style={{ background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(255,255,255,0.04)' }}>
                {['Attestation décennale — RC p.4', 'Planning détaillé — CCTP §3.2', 'Sous-traitance déclarée — RC p.7'].map((txt, i) => (
                  <div key={i} className="flex items-center gap-3 text-xs">
                    <span className="px-1.5 py-0.5 rounded text-[10px] font-medium" style={{ background: ['rgba(245,142,134,0.12)', 'rgba(245,158,11,0.12)', 'rgba(228,233,242,0.12)'][i], color: ['#F58E86', '#F5C26B', '#FFFFFF'][i] }}>
                      {['Critique', 'Important', 'Standard'][i]}
                    </span>
                    <span className="text-[#788295]">{txt}</span>
                  </div>
                ))}
              </div>
            </div>
            ...
            >
              ...
              <h3 className="text-base font-semibold text-[#1C222D] mb-2" style={{ fontFamily: '"Geist Sans", system-ui, sans-serif' }}>Détection des lots</h3>
            ...
            >
              ...
              <h3 className="text-base font-semibold text-[#1C222D] mb-2" style={{ fontFamily: '"Geist Sans", system-ui, sans-serif' }}>Coffre-fort documents</h3>
            ...
            >
              <div className="flex items-start gap-4 mb-5">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-[#1C222D] mb-1" style={{ fontFamily: '"Geist Sans", system-ui, sans-serif' }}>Mémoire technique 5/5</h3>
              ...
              <div className="rounded-lg p-4 space-y-2" style={{ background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(255,255,255,0.04)' }}>
                {['A — Présentation générale', 'B — Prestation & méthodologie', 'C — Planning & sécurité'].map((txt, i) => (
                  <div key={i} className="flex items-center gap-3 text-xs">
                    <div className="w-1.5 h-6 rounded-full" style={{ background: ['#E4E9F2', '#FFFFFF', '#E4E9F2'][i] }} />
                    <span className="text-[#788295]">{txt}</span>
                    <span className="ml-auto text-[10px] text-[#9BA4B5]">{['6 pages', '8 pages', '4 pages'][i]}</span>
                  </div>
                ))}
              </div>
            </div>
            ...
            >
              ...
              <h3 className="text-base font-semibold text-[#1C222D] mb-2" style={{ fontFamily: '"Geist Sans", system-ui, sans-serif' }}>Export ZIP pro</h3>
      ...
      <section id="how" className="py-20 sm:py-28 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div>
              <h3
                className="text-xl font-semibold text-[#1C222D] mb-3"
                style={{ fontFamily: '"Geist Sans", system-ui, sans-serif' }}
              >
                {activeTabData.num}. {activeTabData.title}
              </h3>
              <p className="text-[#788295] leading-relaxed text-sm">{activeTabData.desc}</p>
            </div>
            <div
            ...
            >
              {activeTabData.mock.map((line, i) => (
                ...
                >
                  <div className="w-2 h-2 rounded-full shrink-0" style={{ background: '#E4E9F2' }} />
                  <span className="text-[#5C6678]">{line}</span>
                </div>
              ))}
            </div>
          </div>
      ...
      {/* ════════════════════════════════════════════════════════════════
          STATS
          ════════════════════════════════════════════════════════════════ */}
      <section className="py-20 px-4" style={{ background: '#0A0C11' }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {PLANS.map(plan => (
              <div
                ...
                style={{
                  background: '#0F1218',
                  border: plan.popular ? '1px solid rgba(228,233,242,0.30)' : '1px solid rgba(186,205,234,.13)',
              ...
              >
                ...
                <h3
                  className="text-xl font-bold text-[#1C222D] mb-2"
                  style={{ fontFamily: '"Geist Sans", system-ui, sans-serif' }}
                >
                  {plan.name}
                </h3>
                ...
                <ul className="space-y-3 mb-8">
                  {plan.features.map(f => (
                    <li key={f} className="flex items-center gap-3 text-sm text-[#788295]">
                ...
                <button
                  ...
                  style={plan.popular
                    ...
                    : { background: 'transparent', color: '#5C6678', border: '1px solid rgba(255,255,255,0.15)' }
                  }
                  onMouseEnter={e => {
                    if (plan.popular) e.currentTarget.style.boxShadow = '0 0 40px rgba(228,233,242,0.5)'
                    else e.currentTarget.style.background = 'rgba(186,205,234,.13)'
                  }}
                  onMouseLeave={e => {
      ...
      {/* ════════════════════════════════════════════════════════════════
          TESTIMONIALS
          ════════════════════════════════════════════════════════════════ */}
      <section className="py-20 sm:py-28 px-4" style={{ background: '#0A0C11' }}>
        <div className="max-w-6xl mx-auto">
          <h2
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            {TESTIMONIALS.map((t, i) => (
              ...
              >
                ...
                <p className="text-sm text-[#5C6678] leading-relaxed mb-5 italic">"{t.quote}"</p>
                <div>
                  <div className="text-sm font-semibold text-[#1C222D]">{t.name}</div>
      ...
      <footer className="border-t border-white/[0.06] py-16 px-4" style={{ background: '#0A0C11' }}>
        <div className="max-w-6xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-10">
          <div>
            <h4 className="text-sm font-semibold text-[#1C222D] mb-4" style={{ fontFamily: '"Geist Sans", system-ui, sans-serif' }}>Produit</h4>
          ...
          <div>
            <h4 className="text-sm font-semibold text-[#1C222D] mb-4" style={{ fontFamily: '"Geist Sans", system-ui, sans-serif' }}>Ressources</h4>
            <ul className="space-y-2.5 text-sm text-[#9BA4B5]">
              <li>Documentation</li>
              <li>Blog</li>
              <li>Changelog</li>
          ...
          <div>
            <h4 className="text-sm font-semibold text-[#1C222D] mb-4" style={{ fontFamily: '"Geist Sans", system-ui, sans-serif' }}>Légal</h4>
            <ul className="space-y-2.5 text-sm text-[#9BA4B5]">
          ...
          <div>
            <h4 className="text-sm font-semibold text-[#1C222D] mb-4" style={{ fontFamily: '"Geist Sans", system-ui, sans-serif' }}>Contact</h4>
            <ul className="space-y-2.5 text-sm text-[#9BA4B5]">
        ...
        <div className="max-w-6xl mx-auto mt-12 pt-6 border-t border-white/[0.06] flex flex-col sm:flex-row items-center justify-between gap-3">
          <div className="flex items-center gap-2">
            <div className="w-6 h-6 rounded flex items-center justify-center" style={{ background: 'linear-gradient(135deg, #E4E9F2, #FFFFFF)' }}>
              <span className="text-white font-black text-[10px]">S</span>
            </div>
            <span className="text-sm text-[#9BA4B5]">Synorix</span>
          </div>
          <span className="text-xs text-[#E8EBF2]">© 2026 Synorix. Tous droits réservés.</span>
        </div>
      </footer>
    </div>
  )
