...
const ITEMS = [
  {
    ...
    label: 'AO en cours',
    icon: FolderOpen,
    iconBg: 'linear-gradient(160deg, #2A3342, #46536A)',
    iconGlow: 'rgba(228,233,242,0.35)',
    accentColor: '#E4E9F2',
    suffix: '',
  },
  {
  ...
  },
  {
    ...
    icon: Trophy,
    iconBg: 'linear-gradient(180deg, #F4F6FA 30%, #A2AEC4 100%)',
    iconGlow: 'rgba(228,233,242,0.25)',
    accentColor: '#E4E9F2',
    suffix: '',
  },
  {
    ...
    icon: TrendingUp,
    iconBg: 'linear-gradient(135deg, #9BA4B5 0%, #C7CEDA 100%)',
    iconGlow: 'rgba(120,130,149,0.25)',
    accentColor: '#9BA4B5',
    suffix: '%',
  },
]
