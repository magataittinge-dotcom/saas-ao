...
const inputClass =
  'w-full rounded-lg border px-3 py-2 text-sm bg-white text-[#0F172A] focus:outline-none focus:ring-2 focus:ring-sky-200'
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4"
      ...
      <div className="w-full max-w-md rounded-2xl bg-white p-5 space-y-4 shadow-xl"
        ...
        <div className="flex items-start justify-between">
          ...
          <button onClick={onClose} className="p-1.5 rounded-lg hover:bg-[#F1F5F9]" style={{ color: '#94A3B8' }}>
            <X size={16} />
          </button>
        </div>
        ...
        <div className="space-y-3">
          <div>
            <label className="block text-xs font-medium text-[#475569] mb-1">Catégorie</label>
            <select
          ...
          <div>
            <label className="block text-xs font-medium text-[#475569] mb-1">Type de document</label>
            <select
              className={inputClass} style={inputStyle}
              value={type}
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className="block text-xs font-medium text-[#475569] mb-1">Date d'émission</label>
              <input type="date" className={inputClass} style={inputStyle}
                value={issuedDate} onChange={(e) => setIssuedDate(e.target.value)} />
            </div>
            <div>
              <label className="block text-xs font-medium text-[#475569] mb-1">Valide jusqu'au</label>
              <input type="date" className={inputClass} style={inputStyle}
        ...
        <div className="flex justify-end gap-2 pt-1">
          <button onClick={onClose}
            className="px-3 py-2 rounded-lg text-sm font-medium hover:bg-[#F1F5F9]"
            style={{ color: '#475569' }}>
            Annuler
          </button>
